      ...
      const tableRow = `
				  <div class="row project" data-key="${val.Id}">
					  ...
					  <div class="col-lg-2 col-7 table-mobile-content">
						  ${Object(_utilities_helper__WEBPACK_IMPORTED_MODULE_1__["formatDate"])(val.ModifiedAt)}
					  </div>
					  <div class="d-block d-lg-none col-5 table-mobile-title">
						  Modified By
					  </div>
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.btnCreate').click(function () {
  ...
  new _services_ProjectModuleService__WEBPACK_IMPORTED_MODULE_2__["default"]().createData(newProject).then(() => {
    renderGrid();
  });
});
